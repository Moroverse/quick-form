...
///     @PropertyEditor(keyPath: \PersonForm.givenName)
...
/// let nameResult = model.givenName.validate()
/// // nameResult will be .failure("This field cannot be empty")
///
/// model.givenName.value = "John"
/// let updatedNameResult = model.givenName.validate()
